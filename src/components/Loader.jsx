    ...
    return (
        <Modal
            ...
            <View style={styles.modalContainer}>
                <View style={{backgroundColor: colors.primary, alignItems: 'center', flexDirection: 'row', padding: 15, borderRadius: 10}}>
                    {/* <AnimatedImage /> */}
...
const styles = StyleSheet.create({
    ...
    nonetwork: { fontFamily: fonts.latoRegular, marginTop: 0, textAlign: 'center', padding: 8, paddingLeft: 15, paddingRight: 15, color: colors.white, backgroundColor: colors.primary, borderRadius: 4 }
});
