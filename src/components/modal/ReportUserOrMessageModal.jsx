...
const RadioButton = ({ item, handleCheck }) => {
    return (
        <TouchableOpacity
            ...
            <Icon name={item.checked ? "check-circle" : "circle"} style={{ marginRight: 6, color: colors.primary, fontSize: isIPad ? 18 : 15 }} />
                ...
                <View style={{ backgroundColor: '#fff', borderRadius: 7, width: isIPad ? '70%' : '90%', }}>
                    ...
                    <View style={globalstyle.modalbtnsrow}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <Icon name="x-circle" size={17} color={colors.primary} style={{ marginRight: 10 }} />
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Icon name="check-circle" size={17} color={colors.primary} style={{ marginRight: 10 }} />
