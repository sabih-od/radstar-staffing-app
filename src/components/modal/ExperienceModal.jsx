...
const ExperienceModal = ({ visible, handleCamera, setVisible }) => {
            ...
            <View style={{ ...StyleSheet.absoluteFillObject, zIndex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ backgroundColor: '#fff', borderRadius: 7, width: isIPad ? '70%' : '90%', maxHeight: height - 180 }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15 }}>
                        <View style={{ alignItems: 'flex-start', width: width - 200 }}>
                            <Text style={globalstyle.modaltitle}>Experience</Text>
                            <Text style={[globalstyle.modaldesc, { marginLeft: -15 }]}>Add experience here...</Text>
                        </View>
                        <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', backgroundColor: colors.primary, paddingVertical: 8, width: 80, borderRadius: 10, justifyContent: 'center', height: 35, }}>
