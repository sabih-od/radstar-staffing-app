        ...
        >
            <View style={{ ...StyleSheet.absoluteFillObject, zIndex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ backgroundColor: '#fff', borderRadius: 7, width: isIPad ? '70%' : '90%', overflow: 'hidden' }}>
                    {/* <Text style={{ paddingHorizontal: 25, paddingVertical: 15, backgroundColor: colors.primary, color: colors.white, fontFamily: fonts.latoRegular }}>{item?.message}</Text> */}
                    {/* <View style={{ paddingHorizontal: 25, paddingVertical: 15, flexDirection: 'row', backgroundColor: '#f5f5f5' }} >
                        ...
                        <View style={{ fontFamily: fonts.latoRegular, fontSize: isIPad ? 18 : 14, marginLeft: 10 }}>
                            ...
                            <View style={{ paddingHorizontal: 15, paddingVertical: 9, borderRadius: 7, borderTopLeftRadius: 0, overflow: 'hidden', maxWidth: width - 110, backgroundColor: colors.primary, }}><Text style={{ fontFamily: fonts.latoRegular, fontSize: isIPad ? 18 : 14, color: colors.white, }}>{item?.message}</Text></View>
                        </View>
                    </View> */}
                    ...
                    <View style={{ paddingHorizontal: 20, paddingVertical: 15, paddingBottom: 13, flexDirection: 'row', backgroundColor: '#f5f5f5' }} >
                        ...
                        <View style={{ paddingHorizontal: 10 }}>
                            <View style={{ backgroundColor: colors.primary, paddingVertical: 9, paddingHorizontal: 15, borderRadius: 10, borderBottomLeftRadius: 0, marginBottom: 6 }}>
                    ...
                    <View style={[globalstyle.modalbtnsrow, { flexWrap: 'wrap' }]}>
                        {sender && <TouchableOpacity
                            ...
                            <Icon name="message-circle" size={17} color={colors.primary} style={{ marginRight: 10 }} />
                        ...
                        {!sender && <>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <Icon name="user" size={17} color={colors.primary} style={{ marginRight: 10 }} />
                            ...
                            <TouchableOpacity onPress={() => {
                                setShowDeleteModal(false)
                            }} activeOpacity={0.6} style={[globalstyle.modalbtn, { justifyContent: 'flex-start', paddingLeft: 30, borderTopColor: '#ddd', borderTopWidth: 1, backgroundColor: colors.primary }]}>
...
const styles = StyleSheet.create({
    ...
    // reportmodalbox: { position: 'absolute', backgroundColor: '#f5f5f5', paddingVertical: 1, width: 150, borderRadius: 4, top: 21, zIndex: 5, overflow: 'hidden', borderTopColor: colors.primary, borderTopWidth: 1 },
    ...
    modalstyle: {
        ...
        shadowColor: colors.primary, shadowOffset: { width: 0, height: 9, }, shadowOpacity: 0.30, shadowRadius: 12.35, elevation: 19,
    },
