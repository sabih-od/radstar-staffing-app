            ...
            <View style={{ ...StyleSheet.absoluteFillObject, zIndex: 1, flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View style={{ backgroundColor: '#fff', borderRadius: 7, width: '90%', paddingBottom: 15 }}>
                    ...
                    {/* <View style={{ flexDirection: 'row', alignItems: 'center', borderTopColor: '#ddd', borderTopWidth: 1, }}>
                        <TouchableOpacity onPress={() => { handleCamera(true) }} activeOpacity={0.6} style={{ width: '50%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', borderRightColor: '#ddd', borderRightWidth: 1, }}><Icon name="camera" size={17} color={colors.primary} style={{ marginRight: 10 }} /><Text style={{ fontFamily: fonts.latoRegular, color: colors.black, textAlign: 'center', paddingVertical: 14, textAlign: 'center' }}>Camera</Text></TouchableOpacity>
                        <TouchableOpacity onPress={() => { handleCamera(false) }} activeOpacity={0.6} style={{ width: '50%', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}><Icon name="image" size={17} color={colors.primary} style={{ marginRight: 10 }} /><Text style={{ fontFamily: fonts.latoRegular, color: colors.black, textAlign: 'center', paddingVertical: 14, textAlign: 'center' }}>Gallery</Text></TouchableOpacity>
                    </View> */}
                </View>
            </View>
        </Modal>
...
const styles = StyleSheet.create({
    ...
    rowheading: { fontFamily: fonts.latoBold, minWidth: isIPad ? 170 : 110, color: colors.primary, fontSize: isIPad ? 17 : 14 },
