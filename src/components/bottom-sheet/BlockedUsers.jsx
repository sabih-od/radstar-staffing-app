    ...
    return (
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 10, backgroundColor: (index % 2 == 0) ? '#f7f7f7' : '#fff', borderRadius: 10 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', }}>
                <Image source={item?.profile_picture ? { uri: item?.profile_picture } : require('./../../../assets/images/no-image.png')} style={{ width: 35, height: 35, borderRadius: 35, marginRight: 12, resizeMode: 'cover' }} />
