import { LOGOUT_USER, SET_IS_LOGIN, SET_USER_INFO, UPDATE_CURRENT_SCREEN, UPDATE_FCM_TOKEN, UPDATE_NOTIFICATION_BADGE, UPDATE_MESSAGE_BADGE, SET_ROLE_TYPE } from "../actiontypes";
...
export function SetRoleType(data) {
    return {
        type: SET_ROLE_TYPE,
        payload: data
    }
